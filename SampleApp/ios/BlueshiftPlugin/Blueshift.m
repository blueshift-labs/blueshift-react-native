...
RCT_EXTERN_METHOD(setEnableInApp:(BOOL)isEnabled)
...
RCT_EXTERN_METHOD(registerForInAppNotification:(NSString *)screenName)
RCT_EXTERN_METHOD(unregisterForInAppMessage)
@end
